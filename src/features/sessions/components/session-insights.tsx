...
export function RoundInsights({ round }: { round: RoundDraft }) {
  ...
  return <section className={styles.sessionInsights} aria-labelledby="round-insights-heading">
    <div className={styles.insightsHeading}><div><p className={styles.kicker}>Saved performance</p><h2 id="round-insights-heading">Round Insights</h2><p>Review this Round using its saved Ends and target plots.</p></div></div>
