...
import { calculateDistancePerformance, calculateOverview, calculateTargetGroupings, calculateTrend, filterAnalyticsRounds, getAvailableFilters } from "../src/features/analytics/analytics-model.ts";
...
function session(id, sessionType, date, rounds) { return { id, title: id, date, sessionType, arrowCount: 0, rounds }; }
...
const sessions = [
  session("training-new", "training", "2026-09-23", [completed, incompletePerfect, triple]),
  session("competition-old", "competition", "2026-08-01", [competition]),
];
